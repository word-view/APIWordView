...
public class LyricsService implements LyricsServiceInterface {
        ...
        @Override
        public String getLyrics(String id, String langTag) throws ExtractionException, IOException, LyricsNotFoundException {
                ...
                for (SubtitlesStream subtitle : info.getSubtitles()) {
                        ...
                        if (Objects.equals(subtitle.getLanguageTag(), langTag)) {
                                return subtitle.getContent().replace("&fmt=ttml", "&fmt=vtt");
                        }
                }

                throw new LyricsNotFoundException("Unable to find a lyric for this song");
        }
