...
@Getter
@Setter
public class KnownWordsRequest implements Request {
    private String language;
    private List<String> words;

    public void validate() throws RequestValidationException {
        try {
            Language.Companion.byTag(language);
        ...
        if (words.contains("")) {
            throw new RequestValidationException("One or more of the specified words are a empty string");
        }
    }
}
