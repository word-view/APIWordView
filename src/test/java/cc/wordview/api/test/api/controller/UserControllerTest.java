...
class UserControllerTest {
        ...
        void create() throws Exception {
                TestRequest.post(request, "/users/",
                                new MockUser("arthur", "arthur.araujo@gmail.com", "S_enha64")
                                                .toJson(),
                                status().isCreated());
        }
        ...
        void createUserExistingEmail() throws Exception {
                TestRequest.post(request, "/users/", new MockUser("aaaaaaaa",
                                "arthur.araujo@tutanota.com", "S_enha64").toJson(),
                                status().isForbidden());
        }
        ...
        void login() throws Exception {
                TestRequest.post(request, "/users/login",
