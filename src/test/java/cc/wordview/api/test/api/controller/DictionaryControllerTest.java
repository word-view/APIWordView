...
class DictionaryControllerTest extends ControllerTest {
    ...
    void getDictionary() throws Exception {
        req.post("/dictionary", "{\"lang\":\"ja\", \"text\": \"走る, 聞いて\"}")
                ...
                .andExpect(content().json("{\"dictionary\":[{\"parent\":\"listen\",\"word\":\"聞いて\",\"syntax\":null,\"type\":null,\"time\":null,\"representable\":false,\"pronunciation\":null},{\"parent\":\"run\",\"word\":\"走る\",\"syntax\":null,\"type\":null,\"time\":null,\"representable\":false,\"pronunciation\":null}]}"));
    }
